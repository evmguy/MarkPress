...
<html lang="en">
<head>
    <base href="//modularr.com/">    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="list-inline text-center">
                        <li>
                            <a href="https://twitter.com/ModularrDotCom">
                        ...
                        <li>
                            <a href="https://github.com/Modularr">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <p class="copyright text-muted">Copyright &copy; Modularr 2015</p>
                </div>
            </div>
        </div>
    </footer>
